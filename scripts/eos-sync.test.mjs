 ...
 *
 * Não precisa de build, de rede nem de docker — como `marca.test.js` e
 * `fonte.test.js`. O que se exercita é o núcleo puro de
...
import { plan, provenanceText, stable } from "./sync-engineering-os.mjs";
